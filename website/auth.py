...
def signup():
    if request.method == "POST":
        ...
        if user:
            ...
            )  # hashowanie hasła metodą sha256
            ...
            return redirect(
                url_for("auth.log_in")
            )  # idzie od razu do zalogowane konta ale nie przy pierwszym tworzeniu bazy danych nie wiem czemu
